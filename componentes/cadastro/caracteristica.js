class caracSecund extends HTMLElement {
    ...
    connectedCallback() {
        this.shadowRoot.innerHTML = `
            ...
            <link rel="stylesheet" href="../../css/cadastro/caracteristica.css">
                ...
                <div class="option">
                    ...
                    <div class="requerimento">    
                        <label >Requer:</label>
                        <label >5 pontos e não ter escolhido Resposta Rápida.</label>
                    </div>
                </div>
